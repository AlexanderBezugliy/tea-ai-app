            ...
            <div className="relative mx-auto max-w-7xl">
                ...
                <div className="grid items-center gap-16 lg:grid-cols-2">
                    ...
                    <motion.div style={{ y: textY }} className="space-y-8">
                        ...
                        >
                            Hand-plucked under the gentle glow of the Himalayan
                            moon, this rare first flush captures the essence of
                            spring in every leaf. Notes of muscatel grape and
                            alpine flowers create an ethereal experience.
                        </motion.p>
                        ...
                        >
                            ...
                            <motion.button
                                className="group relative overflow-hidden border border-primary bg-transparent px-10 py-4 font-sans text-xs uppercase tracking-[0.2em] text-primary transition-colors duration-500 hover:text-white"
